      ...
      <section id={id} className={`px-4 py-24 md:py-32 ${className}`}>
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-8 lg:pl-12">{children}</div>
          </div>
        </div>
      </section>
    );
...
export default function CaseStudyClientPage({
  ...
  const scrollToCTA = (e: React.MouseEvent<HTMLAnchorElement | HTMLButtonElement>) => {
  ...
  return (
    <div className="bg-white font-sans text-slate-900 antialiased selection:bg-[#FF6B00]/20">
      ...
      <SectionShell title="At A Glance" className="bg-slate-50 border-y border-slate-200" layout="offset" eyebrow="Executive Summary">
      ...
      <SectionShell title={<span className="flex flex-col gap-4"><Target className="h-12 w-12 text-[#FF6B00]" />The Problem</span>} className="bg-white" layout="offset">
      ...
      <SectionShell title={<span className="flex flex-col gap-4"><Layers className="h-12 w-12 text-[#002542]" />What We Built</span>} className="bg-slate-50 border-y border-slate-200 relative" layout="offset">
      ...
      <SectionShell title={<span className="flex flex-col gap-4"><Trophy className="h-12 w-12 text-[#ff6b00]" />The Result</span>} className="bg-[#002542] text-white" titleClassName="text-white" layout="offset">
      ...
      <SectionShell title={<span className="flex flex-col gap-4"><ThumbsUp className="h-12 w-12 text-[#FF6B00]" />Why This Worked</span>} className="bg-slate-50 border-y border-slate-200" layout="offset">
        <div className="space-y-8 text-xl md:text-2xl leading-relaxed text-slate-700 font-medium">
      ...
      <SectionShell title={<span className="flex flex-col gap-4"><BarChart className="h-12 w-12 text-[#002542]" />Result Highlights</span>} className="bg-white border-b border-slate-200" layout="offset">
        ...
        <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="relative mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm md:p-10">
              ...
              <h3 className="mb-3 ml-2 mt-2 text-3xl font-black text-[#002542]">Book Your Strategy Call</h3>
        ...
        <section className="bg-slate-100 px-4 py-24 md:py-32 border-t border-slate-200">
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 text-center">
              <p className="mb-4 text-sm font-black uppercase tracking-[0.24em] text-[#FF6B00]">Keep Reading</p>
              <h2 className="text-4xl font-black tracking-tight text-[#002542] md:text-5xl">More Success Stories</h2>
            </div>
                ...
                >
                  <div className="relative aspect-video w-full overflow-hidden bg-slate-200">
                    {study.thumbnailVideo ? (
                      ...
                      <Image src={study.img} alt={study.title} fill className="object-cover transition-transform duration-500 group-hover:scale-105" />
                    )}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
                    <div className="absolute bottom-4 left-4 flex items-center gap-2">
                      <span className="rounded-full bg-[#FF6B00] px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">{study.tag}</span>
                    </div>
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    <h3 className="mb-4 text-lg font-black leading-tight text-[#002542] line-clamp-3 group-hover:text-[#FF6B00] transition-colors">{study.title}</h3>
      ...
      <footer className="border-t border-slate-800 bg-slate-900 py-12 text-center">
        ...
        <p className="text-sm font-medium text-slate-500">© {new Date().getFullYear()} New Cape Pictures. All rights reserved.</p>
      </footer>
    </div>
  );
}
